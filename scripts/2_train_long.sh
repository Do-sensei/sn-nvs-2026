#!/bin/bash
# Step 2 (long schedule): antialiased 3DGS training,
#   T = 70,000 iterations, T_du = 45,000.
# Note: scene 5 may exceed 46 GB VRAM during densification under this
# schedule; if that happens, use the medium (60K/40K) result instead.
set -euo pipefail
...
OUT_ROOT="$OUT_DIR/train_70K_45K"
...
for SCENE in 1 2 3 4 5; do
    ...
    echo "[TRAIN 70K/45K] scene-${SCENE}"
